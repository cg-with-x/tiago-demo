...
var Tiago = /** @class */ (function () {
    ...
    Tiago.init = function (param) {
        return __awaiter(this, void 0, void 0, function () {
            var defer, debugInstance, currentScene, isNewComer, queryAIInfo, newComerRoomNum, userInfo;
            return __generator(this, function (_a) {
                defer = new Deferred();
                if (!this._instance) {
                ...
                newComerRoomNum = this._query.roomNum;
                    ...
                    this._config = {
                        ...
                        scene: {
                            liveRoom: {
                                ...
                                newComerRoomNum: newComerRoomNum
                            },
                        },
                    };
                }
    ...
    Tiago.startSingleMatch = function (params) {
        if (params === void 0) { params = { retryCount: 3 }; }
        if (!this._hasInit) {
            throw new TiagoError(ERROR_CODE.WITHOUT_INIT, "please invoke init() before!");
        }
        // 关闭麦克风
