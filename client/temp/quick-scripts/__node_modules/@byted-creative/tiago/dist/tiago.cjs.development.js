...
function (_super) {
  ...
  function GameRoom(params) {
    ...
    _this.log('init game room', params.roomNum, params.userInfo);

    _this.roomNum = params.roomNum;
    var userInfo = params.userInfo;
    _this._debugInstance = params.debugInstance;
    pvpClient.PVPClient.initConfig({
      appId: params.gameId,
      aId: params.hostAppId,
      environment: params.environment === 'online' ? 'online' : 'test',
  ...
  GameRoom.prototype.joinGameRoom = function () {
    var _this = this;
    ...
    room.on('message', function (param) {
      _this.emit('message', param);
    });
    room.on('close', function () {
      _this.emit('error', {
        code: ERROR_CODE.GAME_ROOM_CONNECTION_LOST,
        msg: 'connection to room closed'
      });
    });
  ...
  GameRoom.prototype.send = function (message) {
    this.log('room send', message);
  ...
  GameRoom.prototype.onMessage = function (cb) {
    this.on('message', cb);
  };

  GameRoom.prototype.leave = function () {
    if (this._room) {
  ...
  GameRoom.prototype.onError = function (cb) {
    this.on('error', cb);
  };
...
function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        room = new GameRoom({
          ...
          gameId: this._options.appId || this._query.gameId,
          hostAppId: this._query.hostAppId,
          environment: this._query.environment === 'release' ? 'online' : 'test'
        });
        room.on('open', function () {
          defer.resolve(room);
        });
  ...
  Tiago.joinRTCForGameRoom = function (gameRoom) {
    return __awaiter(this, void 0, void 0, function () {
      var defer, microUI;
      return __generator(this, function (_a) {
        if (!this._hasInit) {
