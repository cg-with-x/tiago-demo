...
var IMAGEURLS = [
    live_ui_source.BACKGROUNDIMG,
    live_ui_source.DEFAULTAVATAR,
    live_ui_source.AVATARBGMIN,
    live_ui_source.AVATARBGMID,
    live_ui_source.AVATARBGMAX,
    live_ui_source.LITTLECIRCLE,
    live_ui_source.BIGCIRCLE,
    live_ui_source.MATCHIMG,
    live_ui_source.MATCHSUCCESS,
    live_ui_source.LEAVEBTN,
    live_ui_source.REDCIRCLE,
    live_ui_source.ZHIBOZHONG,
];
var PLAYERNUM;
(function (PLAYERNUM) {
...
var MatchUICocos = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        cc.director.getScene().addChild(this._matchUI);
                        cc.game.addPersistRootNode(this._matchUI);
                        this._matchUI.width = DESIGNWIDTH;
                        this._matchUI.height = DESIGNHEIGHT;
                        this._matchUI.setSiblingIndex(Number.MAX_VALUE);
                        this._matchUI.setPosition(this._canvas.width * (1 - this._canvas.anchorX), this._canvas.height * (1 - this._canvas.anchorY));
                        bg = new cc.Node('bg');
                        ...
                        return [4 /*yield*/, this.loadImages(IMAGEURLS).then(function (spriteFrames) {
                                ...
                                if (_this._matchUI) {
                                    ...
                                    for (var i = 0; i < _this._loadingNodes.length; i++) {
                                        _this._loadingNodes[i].getComponent(cc.Sprite).spriteFrame =
                                            spriteFrames[IMAGETYPE.LITTLECIRCLE];
                                ...
                                for (var i = 0; i < _this._avatars.length; i++) {
                                    ...
                                    label.getComponent(cc.Label).fontSize = 26;
    ...
    MatchUICocos.prototype.loadImages = function (urls) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.all(urls.map(function (element, index) {
                        return new Promise(function (resolve) {
                            ...
                            image.onload = function () {
                                ...
                                spriteFrame.setOriginalSize(new cc.Size(size.width * MatchUICocos._scale, size.height * MatchUICocos._scale));
                                // console.log('new size ',spriteFrame.getOriginalSize());
                                resolve(spriteFrame);
                            };
                            image.src = element;
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this._delayClose = 0;
                        if (!!this._matchUI) return [3 /*break*/, 2];
                        return [4 /*yield*/, MatchUICocos._instance.createUI()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        if (!debug) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.createDebugUI()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, DebugUI.createUI()];
                    case 1:
                        _a.sent();
                        debugButton = new cc.Node('debugButton');
                        cc.director.getScene().addChild(debugButton);
                        cc.game.addPersistRootNode(debugButton);
                        ...
                        debugLabel.getComponent(cc.Label).string = 'vConsole';
                        // debugLabel.color = cc.Color.RED;
                        return [4 /*yield*/, this.loadImages([live_ui_source.WHITETEXTURE]).then(function (spriteFrames) {
                                ...
                                debugButton.setPosition(debugButton.width / 2, debugButton.height / 2);
                            })];
                    case 2:
                        // debugLabel.color = cc.Color.RED;
                        _a.sent();
    ...
    MatchUICocos.prototype.matchSuccess = function (playerList) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log('show player list', playerList);
                        this._closePromise = new Promise(function (resolve) { return _this._closeResolve = resolve; });
                        return [4 /*yield*/, this.playMatchSuccess()];
                    case 1:
                        _a.sent();
    ...
    MatchUICocos.prototype.setAvatar = function (index, playerInfo) {
        ...
        var nickName = playerInfo.nickName, avatarUrl = playerInfo.avatarUrl, isAnchor = playerInfo.isAnchor;
        if (nickName) {
        ...
        if (avatarUrl) {
            this.loadImages([avatarUrl]).then(function (spriteFrames) {
                if (spriteFrames.length) {
                    var sprite = _this._avatars[index]
                        .getChildByName('mask')
                        .getChildByName('sprite')
    ...
    MatchUICocos.prototype.createAvatarNode = function (avatarParent) {
        ...
        maskNode.height = 180 * MatchUICocos._scale;
        // 这里要在addchild之后再修改类型
...
var DebugUI = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        cc.director.getScene().addChild(this._debugUI);
                        cc.game.addPersistRootNode(this.debugUI);
                        this._debugUI.width = 400;
                        this._debugUI.height = 400;
                        this._debugUI.setSiblingIndex(Number.MAX_VALUE);
                        // this._debugUI.setPosition(
                        //     -canvas.anchorX * canvas.width + this._debugUI.width / 2,
                        //     -canvas.anchorY * canvas.height + this._debugUI.height / 2
                        // );
                        this._debugUI.setPosition(canvas.width / 2, canvas.height / 2);
                        bg = new cc.Node('bg');
                        bg.addComponent(cc.Sprite);
                        ...
                        return [4 /*yield*/, this.loadImages([live_ui_source.WHITETEXTURE]).then(function (spriteFrames) {
                                ...
                                clearButton.color = cc.Color.GREEN;
                                clearButton.setPosition(canvas.width * (0.5 - canvas.anchorX), -canvas.anchorY * canvas.height + clearButton.height / 2);
                                // this._debugUI.setPosition(-canvas.anchorX * canvas.width + this._debugUI.width / 2, -canvas.anchorY * canvas.height + this._debugUI.height / 2);
                            })];
                    case 1:
                        _a.sent();
    ...
    DebugUI.loadImages = function (urls) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.all(urls.map(function (element) {
                        return new Promise(function (resolve) {
                            var image = new window.Image();
                            image.onload = function () {
                                var texture = new cc.Texture2D();
    ...
    DebugUI.show = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this._debugUI) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.createUI()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
...
var MicrophoneUI = /** @class */ (function () {
    function MicrophoneUI() {
    }
    MicrophoneUI.createUI = function () {
        return __awaiter(this, void 0, void 0, function () {
            var viewRect, curScreeRate, canvas, scale, right, layoutInfo, designMenuY, designWorldY, pos, myBtn, otherBtn;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        cc.director.getScene().addChild(this._microphoneUI);
                        this._microphoneUI.setSiblingIndex(Number.MAX_VALUE);
                        scale = cc.view.getDevicePixelRatio() / cc.view.getScaleY();
                        ...
                        // @ts-ignore
                        if (typeof tt !== 'undefined' && tt.getMenuButtonLayout) {
                            // @ts-ignore
                            layoutInfo = tt.getMenuButtonLayout();
                            if (!layoutInfo.top) {
                                layoutInfo.top = 30;
                            }
                            if (!layoutInfo.height) {
                                layoutInfo.height = 32;
                            }
                            // 兼容某些端getLayoutButton bug
                            if (!layoutInfo.right || layoutInfo.right < canvas.width / 2) {
                                layoutInfo.right = layoutInfo.left + layoutInfo.width;
                                if (!layoutInfo.right) {
                                    layoutInfo.right = right / scale;
                                }
                            }
                        }
                        designMenuY = (layoutInfo.top + layoutInfo.height / 2) * scale;
                        designWorldY = canvas.height + 8 - designMenuY + this._microphoneUI.height / 2;
                        pos = this._microphoneUI.parent.convertToNodeSpaceAR(cc.v2(0, designWorldY));
                        this._microphoneUI.setPosition(canvas.width - layoutInfo.right * scale + 76, pos.y);
                        cc.game.addPersistRootNode(this._microphoneUI);
                        ...
                        otherBtn.setPosition(34, -40);
                        otherBtn.addComponent(cc.Button);
                        otherBtn.getComponent(cc.Button).transition =
                        ...
                        return [4 /*yield*/, this.loadImages([
                                live_ui_source.MICMYOPEN,
                                live_ui_source.MICMYCLOSE,
                                live_ui_source.MICOTHEROPEN,
                                live_ui_source.MICOTHERCLOSE,
                            ]).then(function (spriteFrames) {
                                _this._spriteFrames = spriteFrames;
                                _this._mySprite.spriteFrame = spriteFrames[MICIMAGETYPE.MICMYOPEN];
                                _this._otherSprite.spriteFrame =
                                    spriteFrames[MICIMAGETYPE.MICOTHEROPEN];
                                _this._mySprite.sizeMode = cc.Sprite.SizeMode.RAW;
                                _this._otherSprite.sizeMode = cc.Sprite.SizeMode.RAW;
                                // this._microphoneUI.setPosition(canvas.width - this._microphoneUI.width / 2, canvas.height - this._microphoneUI.height / 2);
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    MicrophoneUI.show = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this._microphoneUI) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.createUI()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        ...
                        return [4 /*yield*/, pvp_microphone.PVPMicrophone.init({
                                openID: openID,
                                roomNum: roomNum,
                                appID: appID,
                                source: source,
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, pvp_microphone.PVPMicrophone.startChat()];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 6:
    ...
    MicrophoneUI.clickMyChat = function () {
        var _this = this;
        if (this._isMyOpen) {
            pvp_microphone.PVPMicrophone.disableLocalAudio()
                .then(function () {
            ...
            pvp_microphone.PVPMicrophone.enableLocalAudio()
                .then(function () {
    ...
    MicrophoneUI.clickOtherChat = function () {
        ...
        if (this._isOtherOpen) {
            pvp_microphone.PVPMicrophone.muteAllRemoteAudioStream()
                .then(function () {
            ...
            pvp_microphone.PVPMicrophone.unmuteAllRemoteAudioStream()
                .then(function () {
