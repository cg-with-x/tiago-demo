  ...
  MatchUICocos.prototype.resetAvatar = function () {
    if (this._spriteFrames) {
      for (var i = 0; i < this._avatars.length; i++) {
        var sprite = this._avatars[i].getChildByName('mask').getChildByName('sprite');
        ...
        this._avatars[i].getChildByName('circle').active = false;
        this._avatars[i].getChildByName('label').getComponent(cc.Label).string = '等待中';
      }
    }
  };
