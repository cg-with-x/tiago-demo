...
var config = {
    ...
    channelID: '',
    source: 'live',
    audioStatus: { local: true, remote: true },
};
...
rtcEngine = typeof tt !== 'undefined' && tt.getRtcEngine && tt.getRtcEngine();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_1 = _a.sent();
                    defer.reject({ reason: REASON.GEN_CHANNEL_ERROR, data: err_1 });
                    return [3 /*break*/, 4];
                case 4:
                    if (!(res && res.data && res.data.data)) return [3 /*break*/, 6];
                ...
                case 5:
                    ...
                    return [3 /*break*/, 7];
                case 6:
                    defer.reject({ reason: REASON.GEN_CHANNEL_ERROR, data: res });
                    _a.label = 7;
                case 7: return [2 /*return*/, defer.promise];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    err = null;
                    if (!config.audioStatus.local) return [3 /*break*/, 2];
                    return [4 /*yield*/, enableLocalAudio().catch(function (err) { return err; })];
                case 1:
                    err = _a.sent();
                    return [3 /*break*/, 6];
                case 2: return [4 /*yield*/, disableLocalAudio().catch(function (err) { return err; })];
                case 3:
                    err = _a.sent();
                    return [4 /*yield*/, enableLocalAudio().catch(function (err) { return err; })];
                case 4:
                    err = _a.sent();
                    return [4 /*yield*/, disableLocalAudio().catch(function (err) { return err; })];
                case 5:
                    err = _a.sent();
                    _a.label = 6;
                case 6:
                    ...
                    err = null;
                    if (!config.audioStatus.remote) return [3 /*break*/, 8];
                    return [4 /*yield*/, unmuteAllRemoteAudioStream().catch(function (err) { return err; })];
                case 7:
                    err = _a.sent();
                    return [3 /*break*/, 10];
                case 8: return [4 /*yield*/, muteAllRemoteAudioStream().catch(function (err) { return err; })];
                case 9:
                    err = _a.sent();
                    _a.label = 10;
                case 10:
...
function startChat() {
    ...
    var joinSuccessChannelCb = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    rtcEngine.on('userJoined', function (data) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    rtcEngine.on('connectionLost', function (err) {
        ...
        defer.reject({ reason: REASON.CONNECTION_LOST, data: err });
    });
...
function endChat() {
    ...
    rtcEngine.leaveChannel({
        success: function () { return defer.resolve(); },
        fail: function (err) {
...
function updateMicState(openID, appID, localAudioStatus, remoteAudioStatus) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, stt.request({
