 ...
 */
function init(param) {
    var gameId = param.gameId, hostAppId = param.hostAppId, environment = param.environment, userInfo = param.userInfo, isMultiPlayer = param.isMultiPlayer, isAutoAppendAI = param.isAutoAppendAI, isNewcomer = param.isNewcomer;
